...
const FUN_PASS_LEVELS = [
  ...
  { level:5,  xp:700,  free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'400 Intel',name_ar:'400 إنتل',amount:400},                           premium:{type:'frame',icon:'🖼️',imageUrl:'',name_en:'Neon Frame',name_ar:'إطار نيون',itemId:'fp_frame_neon',rarity:'Rare'} },
  ...
  { level:7,  xp:1400, free:{type:'title',icon:'🕵️',imageUrl:'',name_en:'Agent Title',name_ar:'لقب عميل',itemId:'fp_title_agent',rarity:'Rare'},  premium:{type:'currency',icon:'🧠',imageUrl:'',name_en:'1100 Intel',name_ar:'1100 إنتل',amount:1100} },
  { level:8,  xp:1850, free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'500 Intel',name_ar:'500 إنتل',amount:500},                           premium:{type:'badge',icon:'💎',imageUrl:'',name_en:'Diamond Badge',name_ar:'شارة ألماس',itemId:'fp_badge_diamond',rarity:'Epic'} },
  ...
  { level:10, xp:2900, free:{type:'frame',icon:'🌟',imageUrl:'',name_en:'Star Frame',name_ar:'إطار نجمة',itemId:'fp_frame_star',rarity:'Epic'},    premium:{type:'title',icon:'🌟',imageUrl:'',name_en:'Star Title',name_ar:'لقب نجمة',itemId:'fp_title_star',rarity:'Epic'} },
  ...
  { level:12, xp:4200, free:{type:'badge',icon:'🔥',imageUrl:'',name_en:'Fire Badge',name_ar:'شارة النار',itemId:'fp_badge_fire',rarity:'Epic'},   premium:{type:'currency',icon:'🧠',imageUrl:'',name_en:'1400 Intel',name_ar:'1400 إنتل',amount:1400} },
  { level:13, xp:5000, free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'700 Intel',name_ar:'700 إنتل',amount:700},                           premium:{type:'frame',icon:'💠',imageUrl:'',name_en:'Crystal Frame',name_ar:'إطار كريستال',itemId:'fp_frame_crystal',rarity:'Epic'} },
  ...
  { level:15, xp:6900, free:{type:'title',icon:'⚔️',imageUrl:'',name_en:'Warrior Title',name_ar:'لقب محارب',itemId:'fp_title_warrior',rarity:'Epic'}, premium:{type:'badge',icon:'🏆',imageUrl:'',name_en:'Champion Badge',name_ar:'شارة بطل',itemId:'fp_badge_champion',rarity:'Epic'} },
  ...
  { level:17, xp:9200, free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'850 Intel',name_ar:'850 إنتل',amount:850},                           premium:{type:'frame',icon:'🌀',imageUrl:'',name_en:'Vortex Frame',name_ar:'إطار دوامة',itemId:'fp_frame_vortex',rarity:'Epic'} },
  { level:18, xp:10500,free:{type:'badge',icon:'🎯',imageUrl:'',name_en:'Sniper Badge',name_ar:'شارة القناص',itemId:'fp_badge_sniper',rarity:'Epic'}, premium:{type:'currency',icon:'🧠',imageUrl:'',name_en:'1800 Intel',name_ar:'1800 إنتل',amount:1800} },
  { level:19, xp:12000,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'900 Intel',name_ar:'900 إنتل',amount:900},                           premium:{type:'title',icon:'👁️',imageUrl:'',name_en:'Eye Title',name_ar:'لقب العين',itemId:'fp_title_eye',rarity:'Epic'} },
  { level:20, xp:13700,free:{type:'frame',icon:'👑',imageUrl:'',name_en:'Gold Frame',name_ar:'إطار ذهبي',itemId:'fp_frame_gold',rarity:'Legendary'}, premium:{type:'currency',icon:'🧠',imageUrl:'',name_en:'2000 Intel',name_ar:'2000 إنتل',amount:2000} },
  { level:21, xp:15600,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'950 Intel',name_ar:'950 إنتل',amount:950},                           premium:{type:'badge',icon:'⭐',imageUrl:'',name_en:'Legend Badge',name_ar:'شارة أسطورية',itemId:'fp_badge_legend',rarity:'Legendary'} },
  { level:22, xp:17600,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'1000 Intel',name_ar:'1000 إنتل',amount:1000},                        premium:{type:'frame',icon:'🌙',imageUrl:'',name_en:'Moon Frame',name_ar:'إطار القمر',itemId:'fp_frame_moon',rarity:'Legendary'} },
  { level:23, xp:19800,free:{type:'title',icon:'🌙',imageUrl:'',name_en:'Shadow Title',name_ar:'لقب الظل',itemId:'fp_title_shadow',rarity:'Legendary'}, premium:{type:'currency',icon:'🧠',imageUrl:'',name_en:'2200 Intel',name_ar:'2200 إنتل',amount:2200} },
  { level:24, xp:22200,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'1100 Intel',name_ar:'1100 إنتل',amount:1100},                        premium:{type:'badge',icon:'🌌',imageUrl:'',name_en:'Galaxy Badge',name_ar:'شارة المجرة',itemId:'fp_badge_galaxy',rarity:'Legendary'} },
  { level:25, xp:24800,free:{type:'badge',icon:'🏅',imageUrl:'',name_en:'Gold Badge',name_ar:'شارة ذهبية',itemId:'fp_badge_gold',rarity:'Legendary'}, premium:{type:'title',icon:'🏅',imageUrl:'',name_en:'Gold Title',name_ar:'لقب ذهبي',itemId:'fp_title_gold',rarity:'Legendary'} },
  { level:26, xp:27600,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'1200 Intel',name_ar:'1200 إنتل',amount:1200},                        premium:{type:'frame',icon:'🔥',imageUrl:'',name_en:'Inferno Frame',name_ar:'إطار جهنم',itemId:'fp_frame_inferno',rarity:'Legendary'} },
  ...
  { level:28, xp:33800,free:{type:'frame',icon:'⚡',imageUrl:'',name_en:'Thunder Frame',name_ar:'إطار الرعد',itemId:'fp_frame_thunder',rarity:'Legendary'}, premium:{type:'badge',icon:'⚡',imageUrl:'',name_en:'Thunder Badge',name_ar:'شارة الرعد',itemId:'fp_badge_thunder',rarity:'Legendary'} },
  { level:29, xp:37200,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'1400 Intel',name_ar:'1400 إنتل',amount:1400},                        premium:{type:'title',icon:'🌊',imageUrl:'',name_en:'Ocean Title',name_ar:'لقب المحيط',itemId:'fp_title_ocean',rarity:'Legendary'} },
  { level:30, xp:40800,free:{type:'title',icon:'👑',imageUrl:'',name_en:'King Title',name_ar:'لقب الملك',itemId:'fp_title_king',rarity:'Legendary'}, premium:{type:'frame',icon:'💀',imageUrl:'',name_en:'Skull Frame',name_ar:'إطار الجمجمة',itemId:'fp_frame_skull',rarity:'Legendary'} },
  ...
  { level:32, xp:48600,free:{type:'badge',icon:'🔮',imageUrl:'',name_en:'Mystic Badge',name_ar:'شارة غامضة',itemId:'fp_badge_mystic',rarity:'Legendary'}, premium:{type:'frame',icon:'🔮',imageUrl:'',name_en:'Mystic Frame',name_ar:'إطار غامض',itemId:'fp_frame_mystic',rarity:'Legendary'} },
  { level:33, xp:52900,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'1600 Intel',name_ar:'1600 إنتل',amount:1600},                        premium:{type:'title',icon:'🔥',imageUrl:'',name_en:'Flame Title',name_ar:'لقب اللهب',itemId:'fp_title_flame',rarity:'Legendary'} },
  { level:34, xp:57400,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'1700 Intel',name_ar:'1700 إنتل',amount:1700},                        premium:{type:'badge',icon:'💥',imageUrl:'',name_en:'Blast Badge',name_ar:'شارة الانفجار',itemId:'fp_badge_blast',rarity:'Legendary'} },
  { level:35, xp:62200,free:{type:'frame',icon:'🌈',imageUrl:'',name_en:'Rainbow Frame',name_ar:'إطار قوس قزح',itemId:'fp_frame_rainbow',rarity:'Legendary'}, premium:{type:'title',icon:'🌈',imageUrl:'',name_en:'Rainbow Title',name_ar:'لقب قوس قزح',itemId:'fp_title_rainbow',rarity:'Legendary'} },
  ...
  { level:37, xp:72500,free:{type:'badge',icon:'🌑',imageUrl:'',name_en:'Dark Badge',name_ar:'شارة الظلام',itemId:'fp_badge_dark',rarity:'Legendary'}, premium:{type:'frame',icon:'🌑',imageUrl:'',name_en:'Dark Frame',name_ar:'إطار الظلام',itemId:'fp_frame_dark',rarity:'Legendary'} },
  { level:38, xp:78100,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'2000 Intel',name_ar:'2000 إنتل',amount:2000},                        premium:{type:'title',icon:'👁️',imageUrl:'',name_en:'Watcher Title',name_ar:'لقب الراصد',itemId:'fp_title_watcher',rarity:'Legendary'} },
  { level:39, xp:84000,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'2100 Intel',name_ar:'2100 إنتل',amount:2100},                        premium:{type:'badge',icon:'🏹',imageUrl:'',name_en:'Arrow Badge',name_ar:'شارة السهم',itemId:'fp_badge_arrow',rarity:'Legendary'} },
  { level:40, xp:90200,free:{type:'title',icon:'🔮',imageUrl:'',name_en:'Mystic Title',name_ar:'لقب الغموض',itemId:'fp_title_mystic',rarity:'Mythic'}, premium:{type:'frame',icon:'🔮',imageUrl:'',name_en:'Mythic Frame',name_ar:'إطار خرافي',itemId:'fp_frame_mythic',rarity:'Mythic'} },
  ...
  { level:42, xp:103700,free:{type:'badge',icon:'💠',imageUrl:'',name_en:'Prism Badge',name_ar:'شارة المنشور',itemId:'fp_badge_prism',rarity:'Mythic'}, premium:{type:'frame',icon:'💠',imageUrl:'',name_en:'Prism Frame',name_ar:'إطار المنشور',itemId:'fp_frame_prism',rarity:'Mythic'} },
  { level:43, xp:110900,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'2400 Intel',name_ar:'2400 إنتل',amount:2400},                       premium:{type:'title',icon:'💠',imageUrl:'',name_en:'Prism Title',name_ar:'لقب المنشور',itemId:'fp_title_prism',rarity:'Mythic'} },
  { level:44, xp:118500,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'2600 Intel',name_ar:'2600 إنتل',amount:2600},                       premium:{type:'badge',icon:'🌀',imageUrl:'',name_en:'Void Badge',name_ar:'شارة الفراغ',itemId:'fp_badge_void',rarity:'Mythic'} },
  { level:45, xp:126500,free:{type:'frame',icon:'🌀',imageUrl:'',name_en:'Void Frame',name_ar:'إطار الفراغ',itemId:'fp_frame_void',rarity:'Mythic'}, premium:{type:'title',icon:'🌀',imageUrl:'',name_en:'Void Title',name_ar:'لقب الفراغ',itemId:'fp_title_void',rarity:'Mythic'} },
  ...
  { level:47, xp:143700,free:{type:'badge',icon:'🔥',imageUrl:'',name_en:'Phoenix Badge',name_ar:'شارة الفينيكس',itemId:'fp_badge_phoenix',rarity:'Mythic'}, premium:{type:'frame',icon:'🔥',imageUrl:'',name_en:'Phoenix Frame',name_ar:'إطار الفينيكس',itemId:'fp_frame_phoenix',rarity:'Mythic'} },
  { level:48, xp:152900,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'3000 Intel',name_ar:'3000 إنتل',amount:3000},                       premium:{type:'title',icon:'🔥',imageUrl:'',name_en:'Phoenix Title',name_ar:'لقب الفينيكس',itemId:'fp_title_phoenix',rarity:'Mythic'} },
  { level:49, xp:162600,free:{type:'currency',icon:'🧠',imageUrl:'',name_en:'3200 Intel',name_ar:'3200 إنتل',amount:3200},                       premium:{type:'badge',icon:'🌟',imageUrl:'',name_en:'Nova Badge',name_ar:'شارة النجم المتفجر',itemId:'fp_badge_nova',rarity:'Mythic'} },
  { level:50, xp:172700,free:{type:'frame',icon:'🌟',imageUrl:'',name_en:'Nova Frame',name_ar:'إطار النجم المتفجر',itemId:'fp_frame_nova',rarity:'Mythic'}, premium:{type:'title',icon:'🔱',imageUrl:'',name_en:'GOD Title',name_ar:'لقب الإله',itemId:'fp_title_god',rarity:'Mythic'} },
];
...
const SHOP_ITEMS = {
    ...
    profileEffects: [
        { id: 'effect_sakura', name_en: "Sakura Petals", name_ar: "زهور الكرز", cost: 800, type: 'profileEffects', preview: '🌸', imageUrl: 'https://i.ibb.co/1tvtgmD8/ezgif-com-optimize.gif', rarity: 'Rare',
          particles: [{emoji:'🌸',count:12},{emoji:'🌺',count:8}], duration: 2000, description_en:'Cherry blossoms float across the profile', description_ar:'زهور الكرز تتساقط على البروفايل' },
        { id: 'effect_stars', name_en: "Star Burst", name_ar: "انفجار نجوم", cost: 1200, type: 'profileEffects', preview: '⭐', imageUrl: '', rarity: 'Epic',
          particles: [{emoji:'⭐',count:10},{emoji:'✨',count:14},{emoji:'💫',count:8}], duration: 2000, description_en:'Stars explode across the profile', description_ar:'نجوم تنفجر على البروفايل' },
        { id: 'effect_fire', name_en: "Fire Storm", name_ar: "عاصفة نارية", cost: 1500, type: 'profileEffects', preview: '🔥', imageUrl: '', rarity: 'Epic',
          particles: [{emoji:'🔥',count:15},{emoji:'💥',count:6}], duration: 2000, description_en:'Flames engulf the profile', description_ar:'ألسنة النار تغطي البروفايل' },
        { id: 'effect_money', name_en: "Money Rain", name_ar: "مطر الأموال", cost: 2000, type: 'profileEffects', preview: '💰', imageUrl: '', rarity: 'Legendary',
          particles: [{emoji:'💰',count:10},{emoji:'🧠',count:12},{emoji:'💵',count:8}], duration: 2000, description_en:'Intel rains down the profile', description_ar:'مطر من الانتل على البروفايل' },
        { id: 'effect_hearts', name_en: "Heart Shower", name_ar: "دش القلوب", cost: 900, type: 'profileEffects', preview: '💖', imageUrl: '', rarity: 'Rare',
          particles: [{emoji:'💖',count:12},{emoji:'💕',count:10},{emoji:'❤️',count:8}], duration: 2000, description_en:'Hearts shower the profile', description_ar:'قلوب تنهمر على البروفايل' },
        { id: 'effect_galaxy', name_en: "Galaxy", name_ar: "مجرة", cost: 3000, type: 'profileEffects', preview: '🌌', imageUrl: '', rarity: 'Mythic',
          particles: [{emoji:'🌟',count:8},{emoji:'💫',count:10},{emoji:'🌙',count:6},{emoji:'⭐',count:8}], duration: 2500, description_en:'A galaxy swirls around the profile', description_ar:'مجرة تدور حول البروفايل' },
        { id: 'effect_crown', name_en: "Royal Crown", name_ar: "تاج ملكي", cost: 2500, type: 'profileEffects', preview: '👑', imageUrl: '', rarity: 'Legendary',
          particles: [{emoji:'👑',count:6},{emoji:'💎',count:8},{emoji:'✨',count:12}], duration: 2000, description_en:'Crown and jewels adorn the profile', description_ar:'التاج والجواهر تزين البروفايل' },
        { id: 'effect_ghost', name_en: "Ghost Mode", name_ar: "وضع الشبح", cost: 1800, type: 'profileEffects', preview: '👻', imageUrl: '', rarity: 'Epic',
          particles: [{emoji:'👻',count:8},{emoji:'💀',count:6},{emoji:'🕯️',count:8}], duration: 2000, description_en:'Ghosts haunt the profile', description_ar:'أشباح تسكن البروفايل' },
    ],
    titles: [
...
const ACHIEVEMENTS = [
    ...
    // Moment Likes Achievements
    { id: 'ach_likes_100', nameKey: 'achLikes100', descKey: 'achLikes100Desc', icon: '❤️', imageUrl: '', condition: { type: 'moment_likes', value: 100 } },
    { id: 'ach_likes_500', nameKey: 'achLikes500', descKey: 'achLikes500Desc', icon: '💖', imageUrl: '', condition: { type: 'moment_likes', value: 500 } },
    { id: 'ach_likes_1000', nameKey: 'achLikes1000', descKey: 'achLikes1000Desc', icon: '💝', imageUrl: '', condition: { type: 'moment_likes', value: 1000 } },
    { id: 'ach_likes_5000', nameKey: 'achLikes5000', descKey: 'achLikes5000Desc', icon: '👑', imageUrl: '', condition: { type: 'moment_likes', value: 5000 } },

    // Comment Likes Achievements
    { id: 'ach_comment_likes_100', nameKey: 'achCommentLikes100', descKey: 'achCommentLikes100Desc', icon: '💬', imageUrl: '', condition: { type: 'comment_likes', value: 100 } },
    { id: 'ach_comment_likes_500', nameKey: 'achCommentLikes500', descKey: 'achCommentLikes500Desc', icon: '🗨️', imageUrl: '', condition: { type: 'comment_likes', value: 500 } },
    { id: 'ach_comment_likes_1000', nameKey: 'achCommentLikes1000', descKey: 'achCommentLikes1000Desc', icon: '💬', imageUrl: '', condition: { type: 'comment_likes', value: 1000 } },
    { id: 'ach_comment_likes_5000', nameKey: 'achCommentLikes5000', descKey: 'achCommentLikes5000Desc', icon: '🏅', imageUrl: '', condition: { type: 'comment_likes', value: 5000 } },
];
...
const TRANSLATIONS = { 
    en: { 
        ...
        // Likes Achievements
        achLikes100: "Popular Post", achLikes100Desc: "Get 100 likes on your moments",
        achLikes500: "Trending", achLikes500Desc: "Get 500 likes on your moments",
        achLikes1000: "Viral", achLikes1000Desc: "Get 1,000 likes on your moments",
        achLikes5000: "Megastar", achLikes5000Desc: "Get 5,000 likes on your moments",
        achCommentLikes100: "Comment Star", achCommentLikes100Desc: "Get 100 likes on your comments",
        achCommentLikes500: "Comment Pro", achCommentLikes500Desc: "Get 500 likes on your comments",
        achCommentLikes1000: "Comment Master", achCommentLikes1000Desc: "Get 1,000 likes on your comments",
        achCommentLikes5000: "Comment Legend", achCommentLikes5000Desc: "Get 5,000 likes on your comments",
        // Profile Effect
        profileEffect: "Profile Effect", loginToSeeMore: "Login to see more",
    }, 
    ar: { 
        ...
        // Likes Achievements
        achLikes100: "منشور مشهور", achLikes100Desc: "احصل على 100 لايك على لحظاتك",
        achLikes500: "ترند", achLikes500Desc: "احصل على 500 لايك على لحظاتك",
        achLikes1000: "فايرال", achLikes1000Desc: "احصل على 1,000 لايك على لحظاتك",
        achLikes5000: "نجم عملاق", achLikes5000Desc: "احصل على 5,000 لايك على لحظاتك",
        achCommentLikes100: "نجم التعليقات", achCommentLikes100Desc: "احصل على 100 لايك على تعليقاتك",
        achCommentLikes500: "محترف التعليقات", achCommentLikes500Desc: "احصل على 500 لايك على تعليقاتك",
        achCommentLikes1000: "سيد التعليقات", achCommentLikes1000Desc: "احصل على 1,000 لايك على تعليقاتك",
        achCommentLikes5000: "أسطورة التعليقات", achCommentLikes5000Desc: "احصل على 5,000 لايك على تعليقاتك",
        // Profile Effect
        profileEffect: "تأثير البروفايل", loginToSeeMore: "سجل الدخول لرؤية المزيد",
    } 
};
                    ...
                    {activeTab === 'missions' && (
                        <>
                            ...
                            {FUN_PASS_DAILY_MISSIONS.map(m => {
                                const todayStr = new Date().toDateString();
                                const seasonMissions = userData?.funPass?.seasons?.[FUN_PASS_SEASON_ID]?.missions || {};
                                const missionData = seasonMissions[m.id] || {};
                                const isDoneToday = missionData.lastCompleted === todayStr;
                                return (
                                <div key={m.id} style={{
                                    display:'flex', alignItems:'center', justifyContent:'space-between', gap:'8px',
                                    padding:'9px 12px', borderRadius:'10px',
                                    background: isDoneToday ? 'rgba(74,222,128,0.06)' : 'rgba(255,255,255,0.04)',
                                    border: isDoneToday ? '1px solid rgba(74,222,128,0.25)' : '1px solid rgba(255,255,255,0.07)'
                                }}>
                                    <div style={{display:'flex', alignItems:'center', gap:'8px'}}>
                                        <span style={{fontSize:'18px'}}>{m.icon}</span>
                                        <div>
                                            <div style={{fontSize:'11px', fontWeight:700, color: isDoneToday ? '#4ade80' : '#e2e8f0'}}>{lang==='ar'?m.name_ar:m.name_en}</div>
                                            <div style={{fontSize:'9px', color:'#fbbf24', fontWeight:700}}>+{m.xp} XP</div>
                                        </div>
                                    </div>
                                    {isDoneToday ? (
                                        <div style={{fontSize:'9px', color:'#4ade80', fontWeight:700, background:'rgba(74,222,128,0.1)', padding:'3px 8px', borderRadius:'5px'}}>
                                            ✓ {lang==='ar'?'مكتمل':'Done'}
                                        </div>
                                    ) : (
                                        <button
                                            onClick={async () => {
                                                if (!user) return;
                                                await usersCollection.doc(user.uid).update({
                                                    [`funPass.seasons.${FUN_PASS_SEASON_ID}.missions.${m.id}`]: { lastCompleted: todayStr },
                                                    [`funPass.seasons.${FUN_PASS_SEASON_ID}.xp`]: firebase.firestore.FieldValue.increment(m.xp)
                                                });
                                                onNotification(`+${m.xp} XP! 🎉`);
                                            }}
                                            style={{fontSize:'9px', color:'#fbbf24', fontWeight:700, background:'rgba(251,191,36,0.1)', padding:'3px 8px', borderRadius:'5px', border:'1px solid rgba(251,191,36,0.3)', cursor:'pointer'}}
                                        >
                                            {lang==='ar'?'استلم':'Claim'}
                                        </button>
                                    )}
                            ...
                            {FUN_PASS_WEEKLY_MISSIONS.map(m => {
                                ...
                                const weekStr = new Date(d.getFullYear(), d.getMonth(), diff).toDateString();
                                const seasonMissions = userData?.funPass?.seasons?.[FUN_PASS_SEASON_ID]?.missions || {};
                                const missionData = seasonMissions[m.id] || {};
                                const isDoneThisWeek = missionData.lastWeekCompleted === weekStr;
                                return (
                                <div key={m.id} style={{
                                    display:'flex', alignItems:'center', justifyContent:'space-between', gap:'8px',
                                    padding:'9px 12px', borderRadius:'10px',
                                    background: isDoneThisWeek ? 'rgba(192,132,252,0.06)' : 'rgba(168,85,247,0.05)',
                                    border: isDoneThisWeek ? '1px solid rgba(192,132,252,0.25)' : '1px solid rgba(168,85,247,0.15)'
                                }}>
                                    <div style={{display:'flex', alignItems:'center', gap:'8px'}}>
                                        <span style={{fontSize:'18px'}}>{m.icon}</span>
                                        <div>
                                            <div style={{fontSize:'11px', fontWeight:700, color: isDoneThisWeek ? '#c084fc' : '#e2e8f0'}}>{lang==='ar'?m.name_ar:m.name_en}</div>
                                            <div style={{fontSize:'9px', color:'#c084fc', fontWeight:700}}>+{m.xp} XP</div>
                                        </div>
                                    </div>
                                    {isDoneThisWeek ? (
                                        <div style={{fontSize:'9px', color:'#c084fc', fontWeight:700, background:'rgba(192,132,252,0.1)', padding:'3px 8px', borderRadius:'5px'}}>
                                            ✓ {lang==='ar'?'مكتمل':'Done'}
                                        </div>
                                    ) : (
                                        <button
                                            onClick={async () => {
                                                if (!user) return;
                                                await usersCollection.doc(user.uid).update({
                                                    [`funPass.seasons.${FUN_PASS_SEASON_ID}.missions.${m.id}`]: { lastWeekCompleted: weekStr },
                                                    [`funPass.seasons.${FUN_PASS_SEASON_ID}.xp`]: firebase.firestore.FieldValue.increment(m.xp)
                                                });
                                                onNotification(`+${m.xp} XP! 🎉`);
                                            }}
                                            style={{fontSize:'9px', color:'#c084fc', fontWeight:700, background:'rgba(192,132,252,0.1)', padding:'3px 8px', borderRadius:'5px', border:'1px solid rgba(192,132,252,0.3)', cursor:'pointer'}}
                                        >
                                            {lang==='ar'?'استلم':'Claim'}
                                        </button>
                                    )}
...
const ProfileEffectOverlay = ({ effectId }) => {
    ...
    useEffect(() => {
        ...
        setVisible(true);
        // Fade out after effect duration
        const timer = setTimeout(() => setVisible(false), effect.duration || 2000);
        ...
        <div style={{
            ...
            {particles.map(p => (
                <div key={p.id} style={{
                    ...
                    top: '-10%',
                    fontSize: `${p.size}px`,
                    animation: `pe-fall ${p.duration}s ease-in ${p.delay}s forwards`,
                    opacity: 0,
                }}>
                    {p.emoji}
                </div>
            ...
            {selectedGiftDetail && (
                ...
                <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.85)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:Z.TOOLTIP,padding:'16px'}} onClick={() => setSelectedGiftDetail(null)}>
                    <div className="gift-detail-modal animate-pop" onClick={e => e.stopPropagation()} style={{
                        ...
                        background: selectedGiftDetail.rKey === 'Mythic'
                            ? 'linear-gradient(180deg,#1a0010,#0f0020)'
                            : selectedGiftDetail.rKey === 'Legendary'
                            ? 'linear-gradient(180deg,#1a1000,#0f0800)'
                            : selectedGiftDetail.rKey === 'Epic'
                            ? 'linear-gradient(180deg,#0e0a1a,#080512)'
                            : selectedGiftDetail.rKey === 'Uncommon'
                            ? 'linear-gradient(180deg,#001a0a,#000f06)'
                            : 'linear-gradient(180deg,#0f0f1a,#080812)',
                        boxShadow: selectedGiftDetail.rKey === 'Mythic'
                            ? `0 0 40px rgba(255,0,85,0.6), 0 0 80px rgba(255,0,85,0.2), inset 0 0 30px rgba(255,0,85,0.05)`
                            : selectedGiftDetail.rKey === 'Legendary'
                            ? `0 0 30px rgba(245,158,11,0.5), 0 0 60px rgba(245,158,11,0.15)`
                            : selectedGiftDetail.rKey === 'Epic'
                            ? `0 0 24px rgba(168,85,247,0.4), 0 0 50px rgba(168,85,247,0.1)`
                            : selectedGiftDetail.rKey === 'Uncommon'
                        ...
                        <div style={{
                            ...
                            background: `linear-gradient(90deg, transparent, ${selectedGiftDetail.rarity.color}, transparent)`,
                        }}/>
                        <button className="gift-detail-close" onClick={() => setSelectedGiftDetail(null)}>✕</button>
                        <div className="gift-detail-emoji" style={{
                            filter: selectedGiftDetail.rKey === 'Mythic' ? 'drop-shadow(0 0 12px rgba(255,0,85,0.8))' :
                                    selectedGiftDetail.rKey === 'Legendary' ? 'drop-shadow(0 0 10px rgba(245,158,11,0.7))' :
                                    selectedGiftDetail.rKey === 'Epic' ? 'drop-shadow(0 0 8px rgba(168,85,247,0.6))' : 'none'
...
const AchievementsDisplayV11 = ({ userData, lang, showAll = false }) => {
    ...
    const getProgress = (achievement) => {
        ...
        switch (condition.type) {
            ...
            case 'moment_likes': current = userData?.totalMomentLikes || 0; break;
            case 'comment_likes': current = userData?.totalCommentLikes || 0; break;
            default: current = 0;
        }
    ...
    const getCurrentValue = (achievement) => {
        ...
        switch (condition.type) {
            ...
            case 'moment_likes': return userData?.totalMomentLikes || 0;
            case 'comment_likes': return userData?.totalCommentLikes || 0;
            default: return 0;
        }
    };
        ...
        <div className="modal-overlay" onClick={onClose} style={{zIndex:Z.MODAL}}>
            <div className="profile-glass-card animate-pop" onClick={e => e.stopPropagation()}>
                ...
                <div className="profile-header-bar">
                    ...
                    {/* Three dots menu (only for logged-in users viewing other users) */}
                ...
                >
                    ...
                    {targetData?.equipped?.profileEffects && (
                        <ProfileEffectOverlay effectId={targetData.equipped.profileEffects} />
                    )}
                    ...
                    <>
                        ...
                        {!isOwnProfile && !isTargetGuest && !isBlocked && !blockedByTarget && (
                            <div className="profile-actions">
                                {isGuestViewer ? (
                                    /* Guest user sees login prompt instead of action buttons */
                                    <div style={{
                                        ...
                                        <span style={{fontSize:'11px', color:'#9ca3af', fontWeight:600}}>
                                            {lang === 'ar' ? 'سجل الدخول لإضافة أصدقاء وإرسال الهدايا' : 'Login to add friends & send gifts'}
                                        </span>
                                    </div>
                                ) : isAlreadyFriend ? (
