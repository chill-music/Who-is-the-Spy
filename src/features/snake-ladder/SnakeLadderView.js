...
const [pot, setPot] = useState(0);
    ...
    // ── Settings Modal ───────────────────────────────────────────────────────
    const SNLSettingsModal = ({ settings, lang, t, onClose, onUpdate, selectedBetTier, setSelectedBetTier, pot }) => {
        const el = React.createElement;
        const BET_TIERS = ['10', '20', '50'];
