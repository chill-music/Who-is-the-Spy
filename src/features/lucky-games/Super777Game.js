...
(function () {
  ...
  function injectCSS() {
    ...
    el.textContent = [
      ...
      '.s7-avatar{width:40px;height:40px;position:relative;cursor:pointer;flex-shrink:0;margin-top:-3px;margin-left:-2px;}',
      '.s7-username{flex:1;font-size:13px;font-weight:900;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-left:6px;}',
