...
`;
  ...
  const HELP_PAGES = [{
    ...
    }, "Select the bet amount first, then click on the betting area to place a bet"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 8,
    ...
    }, "\u26FD ", l))), /*#__PURE__*/React.createElement("p", null, "Choose your fuel amount from the presets and confirm during the betting countdown phase."))
  }, {
    title: "Flight & Claim",
    content: /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, "Track the rocket and click CLAIM before it explodes"), /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, "Launch"), " \u2014 rocket lifts off after countdown"), /*#__PURE__*/React.createElement("p", null, "\uD83D\uDCC8 ", /*#__PURE__*/React.createElement("b", {
      style: {
        color: "#fcd34d"
      }
    }, "Multiplier"), " \u2014 rises exponentially over time"), /*#__PURE__*/React.createElement("p", null, "\u26A1 ", /*#__PURE__*/React.createElement("b", {
      style: {
        color: "#4ade80"
      }
    }, "CLAIM"), " \u2014 tap the red button to lock in winnings"), /*#__PURE__*/React.createElement("p", null, "\uD83D\uDCA5 ", /*#__PURE__*/React.createElement("b", {
      style: {
        color: "#f87171"
      }
    }, "Crash"), " \u2014 rocket explodes at a random point")))
  }, {
    title: "Auto Claim",
    content: /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, "Auto-claim prizes when the rocket reaches your target multiplier"), /*#__PURE__*/React.createElement("div", {
      style: {
        background: "rgba(0,0,0,0.3)",
        borderRadius: 10,
        padding: 12,
    ...
    }, /*#__PURE__*/React.createElement("p", null, "\u2705 Enable the ", /*#__PURE__*/React.createElement("b", {
      style: {
        color: "#818cf8"
      }
    }, "Auto claim"), " checkbox below"), /*#__PURE__*/React.createElement("p", null, "\uD83C\uDFAF Set your target multiplier with the +/\u2212 buttons"), /*#__PURE__*/React.createElement("p", null, "\uD83E\uDD16 The game auto-claims when the target is reached"), /*#__PURE__*/React.createElement("p", null, "\uD83D\uDCA1 Lower targets are safer but give smaller rewards")))
  }, {
    ...
    }, /*#__PURE__*/React.createElement("p", null, "\u2022 When using auto-claim, you must remain online. Offline users cannot claim rewards."), /*#__PURE__*/React.createElement("p", {
      style: {
        marginTop: 8
      }
    }, "\u2022 You can modify the auto-claim value only while it is ", /*#__PURE__*/React.createElement("b", {
      style: {
        color: "#fcd34d"
      }
    }, "not enabled"), ". Once enabled it is locked."), /*#__PURE__*/React.createElement("p", {
      style: {
        marginTop: 8
      }
    }, "\u2022 Decide whether to use auto-claim ", /*#__PURE__*/React.createElement("b", {
      style: {
        color: "#fcd34d"
      }
    }, "before the rocket launches"), ". You cannot toggle it mid-flight."))
  }];
  ...
  function CrashGame(props) {
    ...
    const placeBet = () => {
      ...
      if (betInput > balance) {
        if (window.showToast) window.showToast("لا يوجد رصيد كافي", "error");else alert("لا يوجد رصيد كافي");
        return;
      }
    ...
    }, user?.frame && /*#__PURE__*/React.createElement("img", {
      src: user.frame,
      style: {
        position: "absolute",
        top: -5,
    ...
    }, "CRASH"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 10,
    ...
    }, "\uD83D\uDE80 ROCKET")), /*#__PURE__*/React.createElement("div", {
      style: {
        width: 36,
        height: 36,
        borderRadius: "50%",
    ...
    }, "JACKPOT ", jackpot.toLocaleString(undefined, {
    ...
    }, "NEXT ROUND"), /*#__PURE__*/React.createElement("div", {
      className: "cr-count",
      style: {
        width: 80,
        height: 80,
    ...
    }, "\u2713 BET: ", curBet) : /*#__PURE__*/React.createElement("div", {
      style: {
        color: "rgba(255,255,255,0.3)",
        fontSize: 11
      }
    }, "Place your bet!")), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        display: "flex",
        flexDirection: "column",
    ...
    }, "\uD83D\uDE80 PLACE BET")) : /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: "center"
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, "BET CONFIRMED!"), /*#__PURE__*/React.createElement("div", {
      style: {
        color: "rgba(255,255,255,0.4)",
        fontSize: 12,
        marginBottom: 10
      }
    }, "Awaiting launch..."), /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "6px 16px",
        borderRadius: 22,
    ...
    React.createElement("div", {
    ...
    }, "CRASHED!"), isFlying && hasBet && !claimed && /*#__PURE__*/React.createElement("div", {
      style: {
        color: "rgba(255,255,255,0.45)",
        fontSize: 13,
        marginTop: 3,
    ...
    }, "\u2713 LOCKED IN")), /*#__PURE__*/React.createElement("canvas", {
      ref: canvasRef,
      width: 420,
      height: 220,
      style: {
    ...
    }, "CLAIM  ", Math.round(curBet * mult).toLocaleString()) : isFlying && !hasBet ? /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: "center",
        color: "rgba(255,255,255,0.3)",
        fontSize: 12,
    ...
    }, "NO BET THIS ROUND") : isFlying && claimed ? /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: "center",
        color: "#4ade80",
        fontSize: 13,
    ...
    }, "\u2713 Cashed out at ", result?.at?.toFixed(2), "x \u2014 waiting for round end") : isCrashed && result ? /*#__PURE__*/React.createElement("div", {
      className: "cr-fadein",
      style: {
        padding: "9px 14px",
        borderRadius: 10,
    ...
    }, "Auto claim")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        alignItems: "center",
        gap: 3,
    ...
    }, "Historical Records"), /*#__PURE__*/React.createElement("button", {
      onClick: () => setShowHist(false),
      style: {
      ...
      }, h >= 10 ? "MEGA" : h >= 5 ? "HIGH" : h >= 2 ? "MED" : "LOW"));
    ...
    }, "Global Jackpot"), /*#__PURE__*/React.createElement("button", {
      onClick: () => setShowJackpot(false),
      style: {
        background: "rgba(255,255,255,0.18)",
        border: "1.5px solid rgba(255,255,255,0.3)",
    ...
    }, "\uD83C\uDFC6 Top Explorers"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 8
    ...
    }, "#", idx + 1, " ", lb.n), /*#__PURE__*/React.createElement("span", {
      style: {
        fontFamily: "'Orbitron',monospace",
        fontSize: 12,
        color: "#4ade80",
    ...
    }, lb.p.toLocaleString(), "x"))))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 8,
        marginBottom: 20
    ...
    }, "Bet 10 ~ 1K")), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
    ...
    }, "Bet 1K ~ 100K")), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
    ...
    }, "Bet \u2265 100K"))), /*#__PURE__*/React.createElement("div", {
      style: {
        background: "rgba(0,0,0,0.3)",
        borderRadius: 10,
        padding: 14,
    ...
    }, "Accumulate multipliers by successfully cashing out your rocket flights. Total progress is the sum of every claimed multiplier."), /*#__PURE__*/React.createElement("li", {
      style: {
        marginBottom: 4
      }
    }, "When your total progress hits ", /*#__PURE__*/React.createElement("b", {
      style: {
        color: "white"
      }
    }, "80,000x"), ", you automatically claim the jackpot tier corresponding to your average bet size."), /*#__PURE__*/React.createElement("li", null, "Leaderboard ranks players based on who is closest to the 80,000x milestone!")))))), showHelp && /*#__PURE__*/React.createElement("div", {
      style: {
        position: "absolute",
        inset: 0,
        background: "rgba(0,0,0,0.75)",
    ...
    }, "Game Instructions"), /*#__PURE__*/React.createElement("button", {
      onClick: () => setShowHelp(false),
      style: {
        background: "rgba(255,255,255,0.18)",
        border: "1.5px solid rgba(255,255,255,0.3)",
    ...
    }, HELP_PAGES[helpPage - 1].title.toUpperCase()), /*#__PURE__*/React.createElement("div", {
      key: helpPage,
      className: "cr-fadein"
    }, HELP_PAGES[helpPage - 1].content)), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
