...
var GiftWallV11 = ({ gifts, lang, onSendGiftToSelf, isOwnProfile, userData, onOpenProfile }) => {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("div", {
      ...
      onMouseLeave: (e) => e.currentTarget.style.boxShadow = 'none' }, /*#__PURE__*/
    ...
    recentUnique.length > 0 ? recentUnique.slice(0, 3).map((g, i) => {
      ...
      return (/*#__PURE__*/
        React.createElement("div", { key: g.id || i, style: {
        ...
        g.giftImageUrl ? /*#__PURE__*/React.createElement("img", { src: g.giftImageUrl, alt: "", style: { width: '32px', height: '32px', objectFit: 'contain' } }) : /*#__PURE__*/
    ...
    React.createElement("div", { onClick: () => setShowWallModal(false), style: {
    ...
    React.createElement("button", { onClick: () => setShowWallModal(false), style: {
    ...
    displayGifts.map((gift) => {
      ...
      return (/*#__PURE__*/
        React.createElement("div", { key: gift.id,
        ...
        React.createElement("img", { src: topSdr.photo, alt: "",
        ...
        React.createElement("img", { src: gift.imageUrl, alt: gift.name_en, style: { width: '40px', height: '40px', objectFit: 'contain', filter: unlocked ? `drop-shadow(0 0 6px ${rarity.color}66)` : 'grayscale(1)' } }) : /*#__PURE__*/
    ...
    React.createElement("button", { onClick: () => setShowAllGifts((v) => !v), style: {
    ...
    gifts.slice(0, 10).map((gift, idx) => {
      ...
      return (/*#__PURE__*/
        React.createElement("div", { key: idx, className: `profile-gift-log-item${isMythicLog ? ' mythic-glow' : ''}`,
          style: isMythicLog ? { border: '1px solid rgba(255,0,85,0.5)', background: 'rgba(255,0,85,0.08)' } : {} }, /*#__PURE__*/
        React.createElement("img", { src: gift.senderPhoto || `https://ui-avatars.com/api/?name=${encodeURIComponent(gift.senderName || 'User')}&background=6366f1&color=fff`,
          alt: "", className: "profile-gift-log-avatar",
          onClick: () => gift.senderId && onOpenProfile && onOpenProfile(gift.senderId),
          title: gift.senderName || 'Unknown' }), /*#__PURE__*/
