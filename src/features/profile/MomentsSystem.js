...
var AllMomentsModal = ({ show, onClose, moments, ownerName, ownerPhoto, lang, onSelectMoment }) => {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement("button", { onClick: onClose, style: { width: '28px', height: '28px', borderRadius: '8px', border: 'none', background: 'rgba(255,255,255,0.07)', color: '#9ca3af', fontSize: '14px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' } }, "\u2039"

    ),
    ownerPhoto ? /*#__PURE__*/
    React.createElement("img", { src: ownerPhoto, alt: "", style: { width: '28px', height: '28px', borderRadius: '50%', objectFit: 'cover', border: '2px solid rgba(0,242,255,0.4)' } }) : /*#__PURE__*/
    React.createElement("div", { style: { width: '28px', height: '28px', borderRadius: '50%', background: 'rgba(0,242,255,0.1)', border: '2px solid rgba(0,242,255,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '13px' } }, "\uD83D\uDCF8"), /*#__PURE__*/

    React.createElement("div", null, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '13px', fontWeight: 800, color: 'white' } }, lang === 'ar' ? 'كل اللحظات' : 'All Moments'), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '9px', color: '#6b7280' } }, ownerName, " \xB7 ", moments.length, " ", lang === 'ar' ? 'لحظة' : 'moments')
    )
    ), /*#__PURE__*/
    ...
    React.createElement("div", { style: { flex: 1, overflowY: 'auto', padding: '10px 12px' } }, /*#__PURE__*/
    React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '6px' } },
    moments.map((moment) => /*#__PURE__*/
    React.createElement("div", { key: moment.id, onClick: () => {onSelectMoment(moment);onClose();}, style: {
    ...
    moment.type === 'image' && moment.mediaUrl ? /*#__PURE__*/
    React.createElement("img", { src: moment.mediaUrl, alt: "", style: { width: '100%', height: '100%', objectFit: 'cover' } }) :
    moment.type === 'video' && moment.mediaUrl ? /*#__PURE__*/
    React.createElement("video", { src: moment.mediaUrl, style: { width: '100%', height: '100%', objectFit: 'cover' }, muted: true }) : /*#__PURE__*/

    React.createElement("div", { style: { fontSize: '11px', color: '#e2e8f0', padding: '8px', textAlign: 'center', lineHeight: 1.3, overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 4, WebkitBoxOrient: 'vertical' } },
    moment.content
    ), /*#__PURE__*/

    React.createElement("div", { style: { position: 'absolute', top: '3px', left: '3px', fontSize: '7px', background: 'rgba(0,0,0,0.6)', borderRadius: '3px', padding: '1px 3px', color: '#00f2ff', fontWeight: 700 } },
    moment.type === 'text' ? '✏️' : moment.type === 'image' ? '🖼️' : '🎥'
    ),
    (moment.likesCount || 0) > 0 && /*#__PURE__*/
    React.createElement("div", { style: { position: 'absolute', bottom: '2px', right: '3px', fontSize: '7px', color: '#f87171', fontWeight: 700 } }, "\u2764\uFE0F", moment.likesCount)
...
var MomentsSection = ({ ownerUID, ownerName, ownerPhoto, currentUser, isOwnProfile, lang, onOpenProfile }) => {
  ...
  return (/*#__PURE__*/
    React.createElement("div", { style: { padding: '4px 2px' } }, /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px', padding: '0 10px' } }, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '13px', fontWeight: 900, color: 'white', display: 'flex', alignItems: 'center', gap: '6px' } }, "\uD83D\uDCF8 ",
    lang === 'ar' ? 'اللحظات' : 'Moments', /*#__PURE__*/
    React.createElement("span", { style: { fontSize: '10px', color: '#6b7280' } }, moments.length)
    ),
    isOwnProfile && /*#__PURE__*/
    React.createElement("button", { onClick: () => setShowCreate(true), style: { background: GR.NEON, border: 'none', borderRadius: '6px', color: 'white', padding: '4px 10px', fontSize: '11px', fontWeight: 800, cursor: 'pointer' } },
    lang === 'ar' ? '+ نشر' : '+ Post'
    )
    ...
    loading ? /*#__PURE__*/
    React.createElement("div", { style: { padding: '40px 0', display: 'flex', justifyContent: 'center' } }, /*#__PURE__*/
    React.createElement("div", { className: "profile-loading-spinner", style: { width: '20px', height: '20px' } })
    ) :
    moments.length === 0 ? /*#__PURE__*/
    React.createElement("div", { style: { background: 'rgba(255,255,255,0.03)', borderRadius: '12px', padding: '40px 20px', textAlign: 'center', border: '1px dashed rgba(255,255,255,0.1)' } }, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '12px', color: '#6b7280' } }, lang === 'ar' ? 'لا توجد لحظات بعد' : 'No moments yet')
    ) : /*#__PURE__*/
    ...
    React.createElement(CreateMomentModal, {
      show: showCreate,
      currentUser: currentUser,
      lang: lang,
      onClose: () => setShowCreate(false) }
    ), /*#__PURE__*/
    React.createElement(AllMomentsModal, {
      show: showAll,
      moments: moments,
      ownerName: ownerName,
    ...
    React.createElement(MomentDetailModal, {
      show: !!selectedMoment,
...
var MomentDetailModal = ({ show, onClose, moment, currentUser, lang, onOpenProfile }) => {
  ...
  return (/*#__PURE__*/
    ...
    moment.authorPhoto ? /*#__PURE__*/
    React.createElement("img", { src: moment.authorPhoto, alt: "", style: { width: '36px', height: '36px', borderRadius: '50%', border: '2px solid rgba(0,242,255,0.3)' } }) : /*#__PURE__*/
    ...
    React.createElement("button", { onClick: onClose, style: { background: 'rgba(255,255,255,0.08)', border: 'none', borderRadius: '8px', width: '30px', height: '30px', cursor: 'pointer', color: 'white' } }, "\u2715")
    )
    ), /*#__PURE__*/

    React.createElement("div", { style: { flex: 1, overflowY: 'auto', padding: '20px' }, className: "custom-scrollbar" }, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '15px', lineHeight: 1.6, color: '#f1f5f9', whiteSpace: 'pre-wrap', marginBottom: '15px' } },
    moment.content
    ),
    moment.mediaUrl && /*#__PURE__*/
    React.createElement("div", { style: { borderRadius: '16px', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)', marginBottom: '20px', background: 'black' } },
    moment.type === 'image' ? /*#__PURE__*/
    React.createElement("img", { src: moment.mediaUrl, alt: "", style: { width: '100%', display: 'block' } }) : /*#__PURE__*/

    React.createElement("video", { src: moment.mediaUrl, controls: true, style: { width: '100%', display: 'block' } })
    ...
    React.createElement("div", { style: { fontSize: '12px', fontWeight: 800, color: '#6b7280', marginBottom: '15px' } }, lang === 'ar' ? 'التعليقات' : 'Comments', " (", comments.length, ")"),
    comments.map((c) => /*#__PURE__*/
    React.createElement("div", { key: c.id, style: { display: 'flex', gap: '10px', marginBottom: '15px' } },
    c.authorPhoto ? /*#__PURE__*/
    ...
    React.createElement(PortalModal, null, /*#__PURE__*/
    React.createElement("div", { style: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: Z.MODAL_HIGH + 10, padding: '16px' }, onClick: () => setShowDeleteConfirm(false) }, /*#__PURE__*/
    React.createElement("div", { style: { background: GR.DARK_CARD, border: '1px solid rgba(239,68,68,0.3)', borderRadius: '14px', padding: '22px 24px', textAlign: 'center', maxWidth: '260px', width: '100%' }, onClick: (e) => e.stopPropagation() }, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '32px', marginBottom: '8px' } }, "\uD83D\uDDD1\uFE0F"), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '14px', fontWeight: 800, color: 'white', marginBottom: '6px' } }, lang === 'ar' ? 'حذف اللحظة؟' : 'Delete Moment?'), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '11px', color: '#9ca3af', marginBottom: '18px' } }, lang === 'ar' ? 'لا يمكن التراجع عن هذا الإجراء' : 'This action cannot be undone'), /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', gap: '8px' } }, /*#__PURE__*/
    React.createElement("button", { onClick: () => setShowDeleteConfirm(false), style: { flex: 1, padding: '9px', borderRadius: '8px', background: 'rgba(255,255,255,0.07)', border: '1px solid rgba(255,255,255,0.1)', color: '#9ca3af', fontSize: '12px', fontWeight: 700, cursor: 'pointer' } }, lang === 'ar' ? 'إلغاء' : 'Cancel'), /*#__PURE__*/
    React.createElement("button", { onClick: () => {setShowDeleteConfirm(false);onDelete(moment.id);}, style: { flex: 1, padding: '9px', borderRadius: '8px', background: 'rgba(239,68,68,0.18)', border: '1px solid rgba(239,68,68,0.4)', color: '#f87171', fontSize: '12px', fontWeight: 700, cursor: 'pointer' } }, lang === 'ar' ? 'حذف' : 'Delete')
    )
    )
    )
    )
...
var CreateMomentModal = ({ show, onClose, currentUser, lang, onPosted }) => {
  ...
  return (/*#__PURE__*/
    React.createElement(PortalModal, null, /*#__PURE__*/
    React.createElement("div", { style: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: Z.MODAL_HIGH, padding: '16px' }, onClick: onClose }, /*#__PURE__*/
    React.createElement("div", { style: { background: GR.DARK_CARD, border: '1px solid rgba(0,242,255,0.25)', borderRadius: '16px', width: '100%', maxWidth: '360px', overflow: 'hidden' }, onClick: (e) => e.stopPropagation() }, /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px', borderBottom: '1px solid rgba(255,255,255,0.08)' } }, /*#__PURE__*/
    React.createElement("span", { style: { fontWeight: 800, fontSize: '15px', color: 'white' } }, lang === 'ar' ? '📸 لحظة جديدة' : '📸 New Moment'), /*#__PURE__*/
    React.createElement("button", { onClick: onClose, style: { background: 'rgba(255,255,255,0.1)', border: 'none', color: '#9ca3af', fontSize: '16px', cursor: 'pointer', borderRadius: '6px', padding: '4px 8px' } }, "\u2715")
    ), /*#__PURE__*/

    React.createElement("div", { style: { padding: '16px' } }, /*#__PURE__*/
    ...
    (momentType === 'image' || momentType === 'video') && /*#__PURE__*/
    React.createElement("div", null, /*#__PURE__*/
    React.createElement("input", { ref: fileRef, type: "file", accept: momentType === 'image' ? 'image/*' : 'video/*', onChange: handleFileChange, style: { display: 'none' } }),
    mediaPreview ? /*#__PURE__*/
    React.createElement("div", { style: { position: 'relative', borderRadius: '10px', overflow: 'hidden', marginBottom: '8px' } },
    momentType === 'image' ? /*#__PURE__*/
    React.createElement("img", { src: mediaPreview, alt: "", style: { width: '100%', maxHeight: '180px', objectFit: 'cover' } }) : /*#__PURE__*/
    React.createElement("video", { src: mediaPreview, controls: true, style: { width: '100%', maxHeight: '180px' } }), /*#__PURE__*/

    React.createElement("button", { onClick: () => {setMediaFile(null);setMediaPreview(null);setTextContent('');}, style: { position: 'absolute', top: '6px', right: '6px', background: 'rgba(0,0,0,0.7)', border: 'none', color: 'white', borderRadius: '50%', width: '24px', height: '24px', cursor: 'pointer', fontSize: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center' } }, "\u2715")
    ) : /*#__PURE__*/

    React.createElement("div", {
      onClick: () => fileRef.current?.click(),
      style: { border: '2px dashed rgba(0,242,255,0.3)', borderRadius: '10px', padding: '24px', textAlign: 'center', cursor: 'pointer', color: '#64748b', fontSize: '12px' } }, /*#__PURE__*/
    ...
    error && /*#__PURE__*/React.createElement("div", { style: { color: '#f87171', fontSize: '11px', marginTop: '6px', textAlign: 'center' } }, error), /*#__PURE__*/
...
var MomentCard = ({ moment, currentUser, lang, onOpenProfile }) => {
  ...
  return (/*#__PURE__*/
    ...
    moment.type === 'text' ? /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '12px', color: '#94a3b8', lineHeight: 1.5, marginBottom: '8px', maxHeight: '60px', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical' } },
    moment.content
    ) : /*#__PURE__*/

    React.createElement("div", { style: { position: 'relative', borderRadius: '8px', overflow: 'hidden', marginBottom: '8px', background: '#000', height: '120px' } },
    moment.type === 'image' ? /*#__PURE__*/
    React.createElement("img", { src: moment.mediaUrl, style: { width: '100%', height: '100%', objectFit: 'cover' }, alt: "" }) : /*#__PURE__*/
    React.createElement("video", { src: moment.mediaUrl, style: { width: '100%', height: '100%', objectFit: 'cover' }, muted: true }),

    moment.type === 'video' && /*#__PURE__*/React.createElement("div", { style: { position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', background: 'rgba(0,0,0,0.2)' } }, "\u25B6\uFE0F")
    ), /*#__PURE__*/


    React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '12px' } }, /*#__PURE__*/
    React.createElement("div", { onClick: onLike, style: { display: 'flex', alignItems: 'center', gap: '4px', color: isLiked ? '#ef4444' : '#6b7280', fontSize: '11px', fontWeight: 800 } }, /*#__PURE__*/
    React.createElement("span", null, isLiked ? '❤️' : '🤍'), " ", moment.likesCount
    ), /*#__PURE__*/
    React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '4px', color: '#6b7280', fontSize: '11px', fontWeight: 800 } }, /*#__PURE__*/
