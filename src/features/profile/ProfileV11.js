(function () {
  ...
  var ProfileV11 = ({
    ...
    var openReportModal = async () => {
      ...
      try {
        // 3. Simple query to check for existing pending reports
    ...
    var handleSendReport = async () => {
      ...
      try {
        ...
        var reportRef = await reportsCollection.add({
          ...
          resolved: false,
          type: 'user',
          originLabelAr: 'بروفايل شخصي',
          originLabelEn: 'User Profile'
        });
              ...
              React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { className: "profile-scroll-container", style: { overflowY: 'auto', overflowX: 'hidden', flex: 1, paddingBottom: '24px' } },
                  ...
                  React.createElement("div", { style: { marginTop: '8px' } },
                    React.createElement(MomentsSection, { 
                      ownerUID: targetUID, 
                      ownerName: targetData?.displayName, 
                      ownerPhoto: targetData?.photoURL, 
                      ownerVipLevel: window.getVIPLevel ? window.getVIPLevel(targetData) : 0,
                ...
                React.createElement(PortalModal, null, /*#__PURE__*/
                  React.createElement("div", {
                    style: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.82)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: Z.MODAL_HIGH, padding: '16px' },
                              ...
                              React.createElement("div", { style: { position: 'relative', width: `${s + 14}px`, height: `${s + 16}px` } }, /*#__PURE__*/
                                React.createElement("svg", { width: s + 14, height: s + 18, viewBox: `0 0 ${s + 14} ${s + 18}`, style: { position: 'absolute', top: 0, left: 0 } }, /*#__PURE__*/
                                  React.createElement("path", {
                                    d: `M7,5 Q${(s + 14) / 2},1 ${s + 7},5 L${s + 7},${s * 0.66} Q${(s + 14) / 2},${s + 16} 7,${s * 0.66} Z`,
                                  ...
                                  React.createElement("path", {
                                    d: `M13,10 Q${(s + 14) / 2},6 ${s + 1},10 L${s + 1},${s * 0.62} Q${(s + 14) / 2},${s + 9} 13,${s * 0.62} Z`,
          ...
          React.createElement("div", { style: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: Z.MODAL, padding: '16px' }, onClick: () => { setShowReportModal(false); setReportReason(''); setReportDescription(''); setReportImagePreview(null); } }, /*#__PURE__*/
            React.createElement("div", { className: "profile-confirm-modal", onClick: (e) => e.stopPropagation(), style: { maxWidth: '320px', width: '100%', maxHeight: '85vh', overflowY: 'auto' } }, /*#__PURE__*/
              ...
              React.createElement("div", { style: { textAlign: 'center', padding: '10px 0' } },
                ...
                React.createElement("div", { style: { fontSize: '12px', color: '#9ca3af', lineHeight: 1.5, marginBottom: '20px' } }, 
                  lang === 'ar' ? 'لقد قمت بالإبلاغ عن هذا الشخص مسبقاً. الفريق يراجع طلبك بالفعل.' : 'You have already reported this person. The team is currently reviewing your request.'
                ),
              ...
              React.createElement("div", { style: { textAlign: 'center', padding: '30px 0' } },
                ...
                React.createElement("div", { style: { fontSize: '12px', color: '#9ca3af' } }, lang === 'ar' ? 'جاري التحقق من البلاغات السابقة...' : 'Checking previous reports...'),
                React.createElement("button", { onClick: () => setShowReportModal(false), style: { marginTop: '20px', background: 'none', border: 'none', color: '#6b7280', fontSize: '11px', cursor: 'pointer', textDecoration: 'underline' } }, lang === 'ar' ? 'إلغاء' : 'Cancel')
              ) : /*#__PURE__*/
              ...
              React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: '8px', padding: '8px 10px', marginBottom: '12px' } }, /*#__PURE__*/
                React.createElement("img", {
                  src: targetData?.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(targetData?.displayName || 'U')}&background=7000ff&color=fff&size=50`,
              ...
              React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '5px', marginBottom: '12px' } },
                [
                  ...
                  map((r) => /*#__PURE__*/
                    React.createElement("button", {
                      key: r.key, onClick: () => setReportReason(r.key), style: {
              ...
              reportImagePreview ? /*#__PURE__*/
                ...
                React.createElement("div", { className: "profile-confirm-actions" }, /*#__PURE__*/
                  ...
                  React.createElement("button", {
                    onClick: handleSendReport, disabled: !reportReason || reportSending, className: "confirm",
