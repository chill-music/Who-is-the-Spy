...
var AchievementsDisplayV11 = ({ userData, lang, showAll = false }) => {
  ...
  return (/*#__PURE__*/
    React.createElement("div", { className: "profile-achievements-section" }, /*#__PURE__*/

    React.createElement("div", { className: "profile-achievements-header", style: { marginBottom: '12px' } }, /*#__PURE__*/
    React.createElement("span", { className: "profile-achievements-title" }, "\uD83C\uDFC6 ",
    ...
    groups.map(({ groupKey, tiers, highestUnlocked, nextTier, progress }) => {
      ...
      return (/*#__PURE__*/
        ...
        React.createElement("span", { style: { fontSize: '9px', color: isUnlocked ? '#e2e8f0' : '#6b7280', textAlign: 'center', lineHeight: 1.3 } },
        TRANSLATIONS[lang]?.[displayTier.nameKey] || groupKey
        ), /*#__PURE__*/


        React.createElement("div", { style: { display: 'flex', gap: '3px', marginTop: '2px' } },
        tiers.map((a) => /*#__PURE__*/
        React.createElement("div", { key: a.id, style: {
        ...
        allDone ? /*#__PURE__*/
        React.createElement("div", { style: { fontSize: '8px', color: '#fbbf24', fontWeight: 700 } },
        lang === 'ar' ? '✓ مكتمل!' : '✓ Complete!'
        ) :
        nextTier && /*#__PURE__*/
        React.createElement("div", { style: { width: '100%' } }, /*#__PURE__*/
        ...
        React.createElement("div", { style: { fontSize: '7px', color: '#6b7280', textAlign: 'center', marginTop: '2px' } },
    ...
    React.createElement("div", {
      ...
      onClick: () => setSelectedGroup(null) }, /*#__PURE__*/

    React.createElement("div", {
      className: "achievement-detail-modal animate-pop",
      onClick: (e) => e.stopPropagation(),
      style: { maxWidth: '340px', width: '100%' } }, /*#__PURE__*/

    React.createElement("div", { style: { fontSize: '13px', fontWeight: 800, color: '#e2e8f0', marginBottom: '12px', textAlign: 'center' } }, "\uD83C\uDFC6 ",
    ...
    selectedGroup.tiers.map((ach) => {
      ...
      return (/*#__PURE__*/
        React.createElement("div", { key: ach.id, style: {
        ...
        React.createElement("div", { style: { fontSize: '11px', fontWeight: 800, color: isUnlocked ? ts.color : '#9ca3af' } },
        ...
        React.createElement("div", { style: { width: '100%', height: '4px', borderRadius: '2px', background: 'rgba(255,255,255,0.08)', overflow: 'hidden' } }, /*#__PURE__*/
        React.createElement("div", { style: { width: `${pct}%`, height: '100%', background: `linear-gradient(90deg,#7c3aed,${ts.color})`, transition: 'width 0.4s' } })
        ), /*#__PURE__*/
        React.createElement("div", { style: { fontSize: '9px', color: '#6b7280', marginTop: '2px' } }, cur, "/", ach.condition.value)
        )

        ),
        isUnlocked && /*#__PURE__*/
        React.createElement("span", { style: { fontSize: '16px', color: '#4ade80' } }, "\u2713")
