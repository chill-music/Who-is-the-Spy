    ...
    rankings.map((fam, i) => {
      ...
      return (/*#__PURE__*/
        React.createElement("div", { key: fam.id,
          ...
          onMouseLeave: (e) => {if (onOpenFamily) e.currentTarget.style.background = isMine ? 'rgba(0,242,255,0.08)' : i < 3 ? 'rgba(255,215,0,0.04)' : 'rgba(255,255,255,0.03)';} }, /*#__PURE__*/

        React.createElement("div", { style: { width: '24px', textAlign: 'center', fontSize: '14px', flexShrink: 0 } },
        i < 3 ? medals[i] : /*#__PURE__*/React.createElement("span", { style: { fontSize: '11px', color: '#4b5563', fontWeight: 800 } }, "#", i + 1)
        ), /*#__PURE__*/
        React.createElement("div", { style: { width: '38px', height: '38px', borderRadius: '50%', overflow: 'hidden', border: `2px solid ${signColor}55`, background: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', flexShrink: 0 } },
        ...
        React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '5px', flexWrap: 'wrap' } }, /*#__PURE__*/
        React.createElement("span", { style: { fontSize: '12px', fontWeight: 800, color: isMine ? '#00f2ff' : 'white', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '110px' } }, fam.name),
        sign && /*#__PURE__*/React.createElement(FamilySignBadge, { tag: fam.tag, color: signColor, small: true, signLevel: signLevel })
        ), /*#__PURE__*/
        React.createElement("div", { style: { fontSize: '10px', color: '#6b7280', marginTop: '1px' } },
        fl.icon, " Lv.", fl.level, " \xB7 \uD83D\uDC65 ", (fam.members || []).length
        )
        ), /*#__PURE__*/
        ...
        React.createElement("div", { style: { fontSize: '12px', fontWeight: 900, color: '#fbbf24' } }, fmtFamilyNum(fam.activeness || 0), " XP"),
        ...
        onOpenFamily && /*#__PURE__*/React.createElement("div", { style: { fontSize: '9px', color: '#4b5563' } }, "\u203A")
        )
        ));

    }),
    rankings.length === 0 && /*#__PURE__*/React.createElement("div", { style: { textAlign: 'center', padding: '30px', color: '#4b5563', fontSize: '12px' } }, lang === 'ar' ? 'لا يوجد ترتيب بعد' : 'No rankings yet')
    ));
