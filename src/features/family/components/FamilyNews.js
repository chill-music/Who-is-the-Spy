...
var FamilyNews = ({ family, newsLog: newsLogProp, currentUserData, lang, S }) => {
  ...
  return (/*#__PURE__*/
    React.createElement("div", { style: { flex: 1, overflowY: 'auto', padding: '14px', display: 'flex', flexDirection: 'column', gap: '6px' } }, /*#__PURE__*/
    React.createElement("div", { style: localS.sectionTitle }, "\uD83D\uDCF0 ", lang === 'ar' ? 'أخبار العائلة' : 'Family News'),

    newsLog.length === 0 ? /*#__PURE__*/
    React.createElement("div", { style: { textAlign: 'center', padding: '40px 20px', color: '#4b5563' } }, /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '36px', marginBottom: '12px' } }, "\uD83D\uDCED"), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '13px', fontWeight: 700, color: '#6b7280', marginBottom: '6px' } },
    lang === 'ar' ? 'لا أخبار بعد' : 'No news yet'
    ), /*#__PURE__*/
    React.createElement("div", { style: { fontSize: '10px', color: '#4b5563', lineHeight: 1.5 } },
    lang === 'ar' ?
    ...
    newsLog.map((item, idx) => {
      ...
      return (/*#__PURE__*/
        React.createElement("div", { key: item.id || idx, style: {
            ...localS.card,
            padding: '10px 12px',
            display: 'flex',
            alignItems: 'center',
        ...
        item.actorPhoto ? /*#__PURE__*/
        React.createElement("img", { src: item.actorPhoto, alt: "", style: { width: '100%', height: '100%', objectFit: 'cover' } }) :
        tc.icon
        ), /*#__PURE__*/
        ...
        item.actorName && /*#__PURE__*/
        React.createElement("div", { style: { fontSize: '11px', fontWeight: 800, color: tc.color, marginBottom: '2px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } },
        item.actorName
        ), /*#__PURE__*/


        React.createElement("div", { style: { fontSize: '11px', color: '#d1d5db', lineHeight: 1.4, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } },
        item.text
        ),

        item.amount > 0 && /*#__PURE__*/
        React.createElement("div", { style: { fontSize: '10px', color: '#fbbf24', fontWeight: 800, marginTop: '3px' } }, "+",
        ...
        React.createElement("div", { style: { fontSize: '9px', color: '#4b5563', flexShrink: 0 } },
        fmtTime(ts)
        )
        ));
