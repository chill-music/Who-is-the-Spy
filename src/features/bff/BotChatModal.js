(function () {
  ...
  var BotChatModal = ({
    ...
    return (/*#__PURE__*/
      ...
      botCfg.photoURL ? /*#__PURE__*/
      React.createElement("img", { src: botCfg.photoURL, alt: "", style: { width: '100%', height: '100%', objectFit: 'cover' } }) :
      botCfg.emoji
      ), /*#__PURE__*/
      ...
      React.createElement("span", { style: { fontSize: '14px', fontWeight: 800, color: 'white' } },
      ...
      React.createElement("div", { style: { flex: 1, overflowY: 'auto', padding: '12px 10px', display: 'flex', flexDirection: 'column', gap: '10px' } },
      ...
      React.createElement("div", { style: { flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '8px', opacity: 0.35, paddingTop: '50px' } }, /*#__PURE__*/
      React.createElement("span", { style: { fontSize: '40px' } }, botCfg.emoji), /*#__PURE__*/
      ...
      React.createElement("div", { key: msg.id, style: {
      ...
      React.createElement("div", { style: { maxWidth: '80%' } }, /*#__PURE__*/
      React.createElement("div", { style: { fontSize: '9px', color: botCfg.color, fontWeight: 700, marginBottom: '3px' } },
      lang === 'ar' ? botCfg.name_ar : botCfg.name_en
      ), /*#__PURE__*/
      ...
      React.createElement("div", { style: { fontSize: '9px', color: '#374151', marginTop: '2px', paddingLeft: '3px' } },
