...
const FUN_PASS_LEVELS = [
  ...
  { level:15, xp:6900, free:{type:'title',icon:'⚔️',imageUrl:'',name_en:'Warrior Title',name_ar:'لقب محارب',itemId:'fp_title_warrior',rarity:'Epic', durationDays:null, season:null}, premium:{type:'badge',icon:'🏆',imageUrl:'',name_en:'Champion Badge',name_ar:'شارة بطل',itemId:'fp_badge_champion',rarity:'Epic', durationDays:null, season:null} },
