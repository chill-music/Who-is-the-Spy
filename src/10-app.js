  ...
  function App() {
    ...
    return (/*#__PURE__*/
      ...
      React.createElement("div", {
        ...
        title: lang === 'ar' ? 'رصيدك' : 'Your Intel' }, /*#__PURE__*/
      ...
      isLoggedIn && /*#__PURE__*/
      React.createElement("button", { className: "new-hbtn", onClick: () => {if (!sessionClaimedToday) setShowLoginRewards(true);},
      ...
      React.createElement("div", { className: "new-avatar-btn",
        onClick: () => {
          if (isLoggedIn) {setShowMyAccount(true);} else
          if (isGuest) {setShowMyAccount(true);} else
          {gameActions.handleGoogleLogin();}
        },
      ...
      isLoggedIn && /*#__PURE__*/
      React.createElement("div", { className: "me-action-card", onClick: () => setShowLuckyGames(true),
        style: { background: 'linear-gradient(135deg,rgba(123,63,255,0.14),rgba(255,140,0,0.09))', border: '1px solid rgba(255,215,0,0.28)' } }, /*#__PURE__*/
      ...
      isLoggedIn && /*#__PURE__*/
      React.createElement("div", { className: "me-action-card", onClick: () => setShowVIPCenter(true),
        style: { background: 'linear-gradient(135deg,rgba(255,215,0,0.08),rgba(255,140,0,0.05))', border: '1px solid rgba(255,215,0,0.2)' } }, /*#__PURE__*/
      ...
      React.createElement("div", { className: `nav-item-new ${activeView === 'me' ? 'active' : ''}`,
        onClick: () => setActiveView('me') }, /*#__PURE__*/
