...
<<<<<<< HEAD
      ...
      showVIPConfirm && ReactDOM.createPortal(/*#__PURE__*/
        React.createElement("div", { style: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.76)', backdropFilter: 'blur(7px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: (Z.MODAL_HIGH || 9000) + 10 },
          onClick: () => setShowVIPConfirm(false) }, /*#__PURE__*/
        React.createElement("div", { style: { background: 'linear-gradient(135deg,#1a0533,#0d0d2b)', border: '2px solid #a855f7', borderRadius: '20px', padding: '28px', maxWidth: '300px', width: '90%', textAlign: 'center', boxShadow: '0 0 60px rgba(168,85,247,0.28)' },
          onClick: (e) => e.stopPropagation() }, /*#__PURE__*/
        React.createElement("div", { style: { fontSize: '44px', marginBottom: '10px' } }, "\uD83D\uDC51"), /*#__PURE__*/
        React.createElement("div", { style: { color: '#e9d5ff', fontWeight: 900, fontSize: '17px', marginBottom: '8px' } },
        hasVIP ? t.renewVIP || 'Renew VIP?' : t.activateVIP || 'Activate VIP?'
        ), /*#__PURE__*/
        React.createElement("div", { style: { color: '#a78bfa', fontSize: '12px', marginBottom: '14px', lineHeight: 1.6 } },
        hasVIP ? t.renewVIPDesc || 'Add 30 more days to your VIP status.' : t.activateVIPDesc || 'Get 30 days of VIP perks + 5,000 XP bonus!'
        ), /*#__PURE__*/
        React.createElement("div", { style: { color: '#fbbf24', fontWeight: 900, fontSize: '18px', marginBottom: '22px', textShadow: '0 0 12px rgba(251,191,36,0.38)' } }, "50,000 \uD83E\uDDE0"), /*#__PURE__*/
        React.createElement("div", { style: { display: 'flex', gap: '10px', justifyContent: 'center' } }, /*#__PURE__*/
        React.createElement("button", { onClick: () => setShowVIPConfirm(false), style: { padding: '10px 20px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.04)', color: '#9ca3af', fontWeight: 600, cursor: 'pointer' } }, t.cancel || 'Cancel'), /*#__PURE__*/
        React.createElement("button", { onClick: () => {setShowVIPConfirm(false);onBuyVIP();}, style: { padding: '10px 24px', borderRadius: '10px', border: 'none', background: 'linear-gradient(135deg,#7c3aed,#a855f7)', color: '#fff', fontWeight: 800, cursor: 'pointer', boxShadow: '0 0 20px rgba(168,85,247,0.45)', fontSize: '14px' } }, t.confirm || 'Confirm')
        )
        )
        ),
        document.body
                ...
                React.createElement("div", {
                  ...
                  (typeof BFF_TOKEN_ITEMS !== 'undefined' ? BFF_TOKEN_ITEMS : []).map((token) => {
                    ...
                    return (/*#__PURE__*/
                      React.createElement("div", {
                        key: token.id,
                        onClick: () => { setSelectedItem(token); setShowPreview(true); },
                        ...
                        React.createElement("div", {
                          style: {
                            ...
                            filter: `drop-shadow(0 0 10px ${token.glow})`
                          }
                        },
                          token.imageURL ? /*#__PURE__*/
                            React.createElement("img", { src: token.imageURL, alt: "", style: { width: '42px', height: '42px', objectFit: 'contain' } }) :
                            token.emoji
                        ), /*#__PURE__*/
                        React.createElement("div", { style: { fontSize: '11px', fontWeight: 800, color: 'white', marginBottom: '2px', textAlign: 'center' } },
                          lang === 'ar' ? token.name_ar : token.name_en
                        ), /*#__PURE__*/
                        React.createElement("div", { style: { fontSize: '10px', color: '#fbbf24', fontWeight: 900 } },
                          token.cost.toLocaleString(), " 🧠"
                        ),
                        myTokenCount > 0 && /*#__PURE__*/
                        React.createElement("div", { style: { position: 'absolute', top: '5px', right: '5px', background: '#4ade80', color: '#000', borderRadius: '50%', width: '16px', height: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '9px', fontWeight: 900 } },
                          myTokenCount
                        )
                      ));
                  })
              ...
              React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '10px' } },
                ...
                React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '10px' } }, /*#__PURE__*/
                  ...
                  React.createElement("div", {
                    ...
                    [
                      ...
                      map((st) => {
                        ...
                        return (/*#__PURE__*/
                          React.createElement("button", {
                            key: st.id, onClick: () => setActiveGiftSubTab(st.id), style: {
                              flexShrink: 0, display: 'flex', alignItems: 'center', gap: '6px',
                              padding: '7px 14px', borderRadius: '10px', fontSize: '11px', fontWeight: active ? 900 : 600,
                              background: active ? 'rgba(0,242,255,0.12)' : 'rgba(255,255,255,0.03)',
                              border: active ? '1px solid rgba(0,242,255,0.32)' : '1px solid rgba(255,255,255,0.06)',
                  ...
                  React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' } }, /*#__PURE__*/
                    React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap' } }, /*#__PURE__*/
                      React.createElement("button", {
                        onClick: () => setShowGiftFilter((p) => !p), style: {
                          display: 'flex', alignItems: 'center', gap: '5px',
                          padding: '5px 11px', borderRadius: '8px', fontSize: '10px', fontWeight: 700,
                          background: showGiftFilter ? 'rgba(0,242,255,0.09)' : 'rgba(255,255,255,0.04)',
                          border: showGiftFilter ? '1px solid rgba(0,242,255,0.28)' : '1px solid rgba(255,255,255,0.07)',
                      ...
                      ['default', 'price_asc', 'price_desc'].map((s) => /*#__PURE__*/
                        React.createElement("button", {
                          key: s, onClick: () => setGiftSort(s), style: {
                            padding: '5px 9px', borderRadius: '7px', fontSize: '9px', fontWeight: 700,
                            background: giftSort === s ? 'rgba(251,191,36,0.1)' : 'rgba(255,255,255,0.04)',
                            border: giftSort === s ? '1px solid rgba(251,191,36,0.32)' : '1px solid rgba(255,255,255,0.06)',
                            color: giftSort === s ? '#fbbf24' : '#4b6070', cursor: 'pointer', transition: 'all 0.15s'
                    ...
                    React.createElement("div", { style: { background: 'rgba(0,0,0,0.28)', border: '1px solid rgba(255,255,255,0.065)', borderRadius: '12px', padding: '12px', display: 'flex', flexDirection: 'column', gap: '10px' } }, /*#__PURE__*/
                      React.createElement("div", null, /*#__PURE__*/
                        ...
                        React.createElement("div", { style: { display: 'flex', flexWrap: 'wrap', gap: '4px' } },
                          ['all', 'Common', 'Uncommon', 'Rare', 'Epic', 'Legendary', 'Mythic'].map((r) => {
                            ...
                            return (/*#__PURE__*/
                              React.createElement("button", {
                                key: r, onClick: () => setGiftRarityFilter(r), style: {
                                  padding: '3px 9px', borderRadius: '6px', fontSize: '9px', fontWeight: 700, cursor: 'pointer', transition: 'all 0.12s',
                                  background: giftRarityFilter === r ? rc.bg || 'rgba(0,242,255,0.13)' : 'rgba(255,255,255,0.03)',
                                  border: giftRarityFilter === r ? `1px solid ${rc.border || '#00f2ff'}` : '1px solid rgba(255,255,255,0.06)',
                                  color: giftRarityFilter === r ? rc.color || '#00f2ff' : '#4b6070'
                      ...
                      React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' } }, /*#__PURE__*/
                        React.createElement("button", {
                          onClick: () => setGiftVIPOnly((p) => !p), style: {
                            padding: '4px 10px', borderRadius: '7px', fontSize: '10px', fontWeight: 700, cursor: 'pointer', transition: 'all 0.15s',
                            background: giftVIPOnly ? 'rgba(239,68,68,0.09)' : 'rgba(255,255,255,0.04)',
                            border: giftVIPOnly ? '1px solid rgba(239,68,68,0.3)' : '1px solid rgba(255,255,255,0.06)',
                            color: giftVIPOnly ? '#ef4444' : '#4b6070'
                        ...
                        (giftRarityFilter !== 'all' || giftVIPOnly || giftSort !== 'default') && /*#__PURE__*/
                        React.createElement("button", {
                          onClick: () => { setGiftRarityFilter('all'); setGiftVIPOnly(false); setGiftSort('default'); }, style: {
                            padding: '4px 9px', borderRadius: '6px', fontSize: '9px', fontWeight: 700, cursor: 'pointer',
                            background: 'rgba(239,68,68,0.07)', border: '1px solid rgba(239,68,68,0.22)', color: '#f87171'
                          }
                        }, "\u2715 ",
                ...
                React.createElement("div", {
                  ...
                  getTabItems(activeTab)?.map((item) => {
                    ...
                    if (activeTab === 'gifts') {
                      ...
                      var cardAnim = isVIPMaxGift && !isVIPLocked ? 'mythic-pulse 2s ease-in-out infinite' :
                         rKey === 'Mythic' ? 'mythic-pulse 2s ease-in-out infinite' : 'none';
                      ...
                      return (/*#__PURE__*/
                        React.createElement("div", {
                          key: item.id,
                          className: `shop-standard-item ${glowClass}`,
                          onClick: () => { if (!isEventOnly) { setSelectedItem(item); setShowPreview(true); } },
                          style: {
                            opacity: isEventOnly || isVIPLocked ? 0.58 : 1,
                          ...
                          React.createElement("span", { style: { position: 'absolute', top: '5px', left: '5px', fontSize: '10px' } }, rarity.icon),
                          isEventItem && /*#__PURE__*/React.createElement("span", { className: "shop-event-tag" }, "⚡"),
                          isLimited && /*#__PURE__*/React.createElement("span", { className: "shop-limited-tag" }, "⌛"),

                          item.durationDays && !isLimited && /*#__PURE__*/
                          React.createElement("span", { style: { position: 'absolute', bottom: '4px', left: '4px', fontSize: '7px', fontWeight: 900, background: 'rgba(245,158,11,0.95)', color: '#000', padding: '1px 4px', borderRadius: '3px' } },
                            item.durationDays, "d"
                          ),

                          isVIPGift && /*#__PURE__*/
                          React.createElement("span", { style: { position: 'absolute', top: '4px', right: '4px', fontSize: '8px', fontWeight: 900, background: vipGlowColor, color: '#000', padding: '1px 5px', borderRadius: '4px', boxShadow: isVIPMaxGift ? `0 0 10px ${vipGlowColor}` : 'none' } }, "V",
                            vipRequired
                          ),

                          item.imageUrl ? /*#__PURE__*/
                            React.createElement("img", { src: item.imageUrl, alt: "", style: { width: '38px', height: '38px', objectFit: 'contain', marginBottom: '4px' } }) : /*#__PURE__*/
                            React.createElement("span", { style: { fontSize: '32px', lineHeight: 1, marginBottom: '4px' } }, item.emoji), /*#__PURE__*/

                          React.createElement("div", { style: { fontSize: '10px', fontWeight: 900, color: '#fbbf24' } }, item.cost.toLocaleString(), "🧠"), /*#__PURE__*/
                          React.createElement("div", { style: { fontSize: '8px', color: '#9ca3af', fontWeight: 700 } }, "+", formatCharisma(item.charisma), "⭐"), /*#__PURE__*/
                          
                          isVIPLocked && /*#__PURE__*/
                          React.createElement("div", { style: { position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.7)', borderRadius: 'inherit', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '3px', zIndex: 10 } }, /*#__PURE__*/
                            React.createElement("span", { style: { fontSize: '20px' } }, "🔒"), /*#__PURE__*/
                            React.createElement("span", { style: { fontSize: '9px', color: vipGlowColor, fontWeight: 900 } }, "VIP ", vipRequired, "+")
                          ),

                          isEventOnly && !isVIPLocked && /*#__PURE__*/
                          React.createElement("div", { style: { position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.6)', borderRadius: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 10 } }, /*#__PURE__*/
                    ...
                    return (/*#__PURE__*/
                      React.createElement("div", {
                        key: item.id,
                        onClick: () => { if (!item.eventOnly) { setSelectedItem(item); setShowPreview(true); } },
                        className: `shop-standard-item ${equippedItem ? 'selected' : ''} shop-rarity-${rKey2.toLowerCase()}`,
                        style: {
                          opacity: item.eventOnly ? 0.58 : 1
                        }
                      }, /*#__PURE__*/

                        React.createElement("span", { style: { position: 'absolute', top: '5px', left: '5px', fontSize: '10px' } }, rarity2.icon),
                        item.isEvent && /*#__PURE__*/React.createElement("span", { className: "shop-event-tag" }, "⚡"),
                        item.limitedTime && /*#__PURE__*/React.createElement("span", { className: "shop-limited-tag" }, "⌛"),
                        equippedItem && /*#__PURE__*/React.createElement("div", { style: { position: 'absolute', top: '5px', right: '5px', width: '8px', height: '8px', borderRadius: '50%', background: '#00f2ff', boxShadow: '0 0 8px #00f2ff', zIndex: 5 } }), /*#__PURE__*/
                        React.createElement("div", { style: { width: '100%', display: 'flex', justifyContent: 'center' } }, renderPreview(item)), /*#__PURE__*/
                        React.createElement("div", { style: { fontSize: '10px', fontWeight: 800, color: equippedItem ? '#00f2ff' : '#d1d5db', textAlign: 'center', lineHeight: 1.2, width: '100%', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', marginTop: 'auto' } },
                          lang === 'ar' ? item.name_ar : item.name_en
                        ),
                        
                        !owned && !item.eventOnly && /*#__PURE__*/
                        React.createElement("div", { style: { fontSize: '10px', color: '#fbbf24', fontWeight: 900 } }, item.cost.toLocaleString(), "🧠")
                      ));
          ...
          (() => {
            ...
            return (/*#__PURE__*/
              React.createElement("div", {
                ...
                React.createElement("div", {
                  style: { background: 'linear-gradient(160deg,#0a0e1f,#0d1225)', border: '1px solid rgba(0,242,255,0.2)', borderRadius: '22px', width: '100%', maxWidth: '320px', overflow: 'hidden', boxShadow: '0 0 80px rgba(0,0,0,0.9)' },
    ...
    var ItemDetailPopup = ({ item, onClose: closePopup }) => {
      ...
      return (/*#__PURE__*/
        React.createElement("div", {
          ...
          React.createElement("div", {
            onClick: (e) => e.stopPropagation(), className: "animate-pop", style: {
                    ...
                    myPackets.map((rpId, idx) => {
                      ...
                      return (/*#__PURE__*/
                        React.createElement("div", { key: rpId + '-' + idx, style: { display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 14px', borderRadius: '14px', background: rp.bg, border: `1px solid ${rp.border}`, boxSizing: 'border-box' } },
                          ...
                          React.createElement("button", {
                            onClick: () => setRpSendModal({ ...rp, inventoryId: rpId }),
                ...
                myRings.length === 0 ? /*#__PURE__*/
                  ...
                  React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '10px' } },
                    [...new Set(myRings)].map((rid) => {
                      ...
                      return (/*#__PURE__*/
                        React.createElement("div", {
                          key: rid, style: { display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 14px', borderRadius: '14px', background: `linear-gradient(135deg,${rd.color}0f,${rd.color}05)`, border: `1px solid ${rd.color}32`, transition: 'all 0.15s' },
                          ...
                          React.createElement("button", {
                            onClick: () => { if (coupleData) { onOpenCoupleCard && onOpenCoupleCard(); } else { onPropose && onPropose(rd); } },
                  ...
                  React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(96px,1fr))', gap: '8px' } },
                    ownedItems.map((item) => {
                      ...
                      if (activeTab === 'gifts') {
                        ...
                        return (/*#__PURE__*/
                          React.createElement("div", {
                            key: item.id, style: { position: 'relative', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.065)', borderRadius: '12px', padding: '10px 8px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '5px', transition: 'all 0.15s', opacity: isExpired ? 0.5 : 1 },
                      ...
                      return (/*#__PURE__*/
                        React.createElement("div", {
                          ...
                          isExpired ? /*#__PURE__*/
                            ...
                            equippedItem ? /*#__PURE__*/
                              React.createElement("button", {
                                onClick: () => onUnequip(item.type, item.id),
