(function () {
  ...
  var FakeProfilesSection = ({ lang, onNotification }) => {
    ...
    return (/*#__PURE__*/
      ...
      React.createElement("div", { style: { fontSize: '13px', fontWeight: 700, color: '#ec4899' } }, "\uD83E\uDD16 ",
      lang === 'ar' ? 'الحسابات الوهمية' : 'Fake Profiles'
      ), /*#__PURE__*/
      React.createElement("button", { onClick: generateProfiles, disabled: generating,
      ...
      profiles.map((p) => /*#__PURE__*/
      React.createElement("div", { key: p.id, style: { background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', padding: '10px', textAlign: 'center', position: 'relative' } }, /*#__PURE__*/
      React.createElement("img", { src: p.photoURL || 'https://via.placeholder.com/50',
        style: { width: '45px', height: '45px', borderRadius: '50%', marginBottom: '6px', border: '2px solid #ec4899' } }), /*#__PURE__*/
      React.createElement("div", { style: { fontSize: '11px', fontWeight: 700, color: '#fff', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' } }, p.displayName), /*#__PURE__*/
      React.createElement("div", { style: { fontSize: '9px', color: '#6b7280', marginBottom: '8px' } }, "ID: ", p.uid?.slice(0, 6)), /*#__PURE__*/
      React.createElement("button", { onClick: () => deleteProfile(p.id),
