(function () {
  ...
  var FinancialLogSection = ({ lang }) => {
    ...
    return (/*#__PURE__*/
      ...
      React.createElement("div", { className: "admin-form-stack", style: { background: 'rgba(245,158,11,0.06)', border: '1px solid rgba(245,158,11,0.2)', borderRadius: '12px', padding: '16px', marginBottom: '20px', display: 'flex', flexDirection: 'column', gap: '8px' } }, /*#__PURE__*/
      ...
      React.createElement("div", { style: { display: 'flex', gap: '8px', marginBottom: '8px', flexWrap: 'wrap' } }, /*#__PURE__*/
      React.createElement("input", { className: "input-dark", style: { flex: 1.5, minWidth: '140px', padding: '8px', fontSize: '11px', minHeight: '44px' }, placeholder: "Target UID", value: targetUID, onChange: (e) => setTargetUID(e.target.value) }), /*#__PURE__*/
      React.createElement("input", { className: "input-dark", style: { flex: 1, minWidth: '80px', padding: '8px', fontSize: '11px', minHeight: '44px' }, placeholder: "Amount", type: "number", value: amount, onChange: (e) => setAmount(e.target.value) })
      ), /*#__PURE__*/
      React.createElement("input", { className: "input-dark", style: { width: '100%', padding: '8px', fontSize: '11px', marginBottom: '10px', minHeight: '44px' }, placeholder: "Reason (Optional)", value: reason, onChange: (e) => setReason(e.target.value) }), /*#__PURE__*/
      React.createElement("button", { onClick: handleSendGold, disabled: processing || !targetUID || !amount,
        className: "btn-neon", style: { width: '100%', padding: '10px', fontSize: '12px', fontWeight: 700, minHeight: '44px' } },
      ...
      React.createElement("div", { style: { width: '100%', overflowX: 'auto', WebkitOverflowScrolling: 'touch' } },
        React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '6px', maxHeight: '40vh', overflowY: 'auto', minWidth: '340px' } },
        ...
        React.createElement("div", { style: { fontSize: '11px', fontWeight: 700, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } }, log.userName), /*#__PURE__*/
        React.createElement("div", { style: { fontSize: '10px', color: '#6b7280', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } }, log.reason)
        ), /*#__PURE__*/
        React.createElement("div", { style: { textAlign: 'right', marginLeft: '10px', flexShrink: 0 } }, /*#__PURE__*/
