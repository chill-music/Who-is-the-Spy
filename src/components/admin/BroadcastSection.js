(function () {
  ...
  var BroadcastSection = ({ currentUser, currentUserData, lang, onNotification }) => {
    ...
    return (/*#__PURE__*/
      ...
      React.createElement("div", { style: { background: 'rgba(245,158,11,0.06)', border: '1px solid rgba(245,158,11,0.2)', borderRadius: '12px', padding: '14px' } }, /*#__PURE__*/
      React.createElement("textarea", { className: "input-dark", style: { width: '100%', padding: '8px 12px', borderRadius: '8px', fontSize: '12px', minHeight: '70px', resize: 'vertical', marginBottom: '8px' },
        placeholder: "Message (EN)",
        value: msg, onChange: (e) => setMsg(e.target.value) }), /*#__PURE__*/
      React.createElement("textarea", { className: "input-dark", style: { width: '100%', padding: '8px 12px', borderRadius: '8px', fontSize: '12px', minHeight: '70px', resize: 'vertical', marginBottom: '10px', direction: 'rtl' },
        placeholder: "\u0627\u0644\u0631\u0633\u0627\u0644\u0629 (\u0639\u0631\u0628\u064A)",
        value: msgAr, onChange: (e) => setMsgAr(e.target.value) }), /*#__PURE__*/
      React.createElement("button", { onClick: handleBroadcast, disabled: sending || !msg.trim() && !msgAr.trim(),
      ...
      sent > 0 && /*#__PURE__*/React.createElement("div", { style: { fontSize: '11px', color: '#10b981', textAlign: 'center', marginTop: '8px' } }, "\u2705 Sent to ", sent, " users")
      )
      ));
