(function () {
  ...
  var SettingsModal = ({ show, onClose, lang, onSetLang, userData, user, onNotification, isGuest: isGuestPropForSettings, onLoginGoogle, onOpenAdminPanel }) => {
    ...
    return (/*#__PURE__*/
      ...
      React.createElement("input", { ref: photoInputRef, id: "settings-photo-input", type: "file", style: { display: 'none' }, accept: "image/*", onChange: async (e) => {
      ...
      React.createElement("button", { key: l, onClick: () => onSetLang && onSetLang(l), style: {
      ...
      React.createElement("button", { onClick: () => {onClose();if (onOpenAdminPanel) onOpenAdminPanel();},
        ...
        onMouseLeave: (e) => e.currentTarget.style.background = 'linear-gradient(135deg,rgba(255,215,0,0.1),rgba(255,140,0,0.07))' }, /*#__PURE__*/
