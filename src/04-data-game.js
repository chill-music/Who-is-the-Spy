(() => {
    ...
    var SHOP_ITEMS = {
        ...
        titles: [
            ...
            { id: 'title_pro', name_en: "Pro Player", name_ar: "محترف", cost: 1000, type: 'titles', preview: '', imageUrl: 'icos/Titles/tittest.png', hidden: false, isEvent: false, limitedTime: false, eventOnly: false, durationDays: null, season: null, textTop: "60%", textLeft: "50%", fontSize: "10px" },
            { id: 'title_shadow', name_en: "Shadow", name_ar: "ظل", cost: 700, type: 'titles', preview: '', imageUrl: 'icos/Titles/Titles%20Shehab.png', hidden: false, isEvent: false, limitedTime: false, eventOnly: false, durationDays: null, season: null, textTop: "48%", textLeft: "50%", fontSize: "10px" },
            // ════ UNCOMMON TITLES ════
            { id: 'title_rookie', name_en: "Rookie", name_ar: "مبتدئ", cost: 80, type: 'titles', rarity: 'Uncommon', preview: '🌱', imageUrl: '', hidden: false, isEvent: false, limitedTime: false, eventOnly: false, durationDays: null, season: null, textTop: "50%", textLeft: "50%", fontSize: "10px" },
            { id: 'title_scout', name_en: "Scout", name_ar: "كشاف", cost: 120, type: 'titles', rarity: 'Uncommon', preview: '🔭', imageUrl: '', hidden: false, isEvent: false, limitedTime: false, eventOnly: false, durationDays: null, season: null, textTop: "50%", textLeft: "50%", fontSize: "10px" },
