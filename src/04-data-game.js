(() => {
    ...
    var SHOP_ITEMS = {
        ...
        titles: [
            ...
            { id: 'title_pro', name_en: "Pro Player", name_ar: "محترف", cost: 1000, type: 'titles', preview: '', imageUrl: 'icos/Titles/tittest.png', hidden: false, isEvent: false, limitedTime: false, eventOnly: false, durationDays: null, season: null },
            ...
            { id: 'fp_title_agent', name_en: "Agent", name_ar: "عميل", cost: 0, type: 'titles', rarity: 'Rare', preview: '🕵️', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_star', name_en: "Star", name_ar: "نجمة", cost: 0, type: 'titles', rarity: 'Epic', preview: '🌟', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_warrior', name_en: "Warrior", name_ar: "محارب", cost: 0, type: 'titles', rarity: 'Epic', preview: '⚔️', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_eye', name_en: "The Eye", name_ar: "العين", cost: 0, type: 'titles', rarity: 'Epic', preview: '👁️', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_shadow', name_en: "Shadow", name_ar: "الظل", cost: 0, type: 'titles', rarity: 'Legendary', preview: '🌙', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_gold', name_en: "Gold", name_ar: "ذهبي", cost: 0, type: 'titles', rarity: 'Legendary', preview: '🏅', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_ocean', name_en: "Ocean", name_ar: "المحيط", cost: 0, type: 'titles', rarity: 'Legendary', preview: '🌊', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_king', name_en: "King", name_ar: "الملك", cost: 0, type: 'titles', rarity: 'Legendary', preview: '👑', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_flame', name_en: "Flame", name_ar: "اللهب", cost: 0, type: 'titles', rarity: 'Legendary', preview: '🔥', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_rainbow', name_en: "Rainbow", name_ar: "قوس قزح", cost: 0, type: 'titles', rarity: 'Legendary', preview: '🌈', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_watcher', name_en: "Watcher", name_ar: "الراصد", cost: 0, type: 'titles', rarity: 'Legendary', preview: '👁️', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_mystic', name_en: "Mystic", name_ar: "الغموض", cost: 0, type: 'titles', rarity: 'Mythic', preview: '🔮', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_prism', name_en: "Prism", name_ar: "المنشور", cost: 0, type: 'titles', rarity: 'Mythic', preview: '💠', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_void', name_en: "Void", name_ar: "الفراغ", cost: 0, type: 'titles', rarity: 'Mythic', preview: '🌀', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_phoenix', name_en: "Phoenix", name_ar: "الفينيكس", cost: 0, type: 'titles', rarity: 'Mythic', preview: '🔥', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
            { id: 'fp_title_god', name_en: "GOD", name_ar: "الإله", cost: 0, type: 'titles', rarity: 'Mythic', preview: '🔱', imageUrl: '', hidden: true, isEvent: false, limitedTime: false, eventOnly: false, durationDays: 3, season: 1 },
