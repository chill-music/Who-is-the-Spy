...
var FAMILY_SHOP_ITEMS = [
    // -- Badges
    { id:'badge_leaf',    emoji:'🌿', name_en:'Leaf Badge',    name_ar:'شارة الورقة',   cost:20,  type:'badge',         rarity:'uncommon',  durationDays:7, desc_en:'Fresh family badge',         desc_ar:'شارة عائلة منعشة' },
    { id:'badge_fire',    emoji:'🔥', name_en:'Fire Badge',    name_ar:'شارة النار',    cost:60,  type:'badge',         rarity:'rare',      durationDays:7, desc_en:'Blazing family badge',       desc_ar:'شارة اللهب الحصرية' },
    { id:'badge_ice',     emoji:'❄️', name_en:'Ice Badge',     name_ar:'شارة الجليد',   cost:60,  type:'badge',         rarity:'rare',      durationDays:7, desc_en:'Cool ice badge',             desc_ar:'شارة الجليد الرائعة' },
    { id:'badge_star',    emoji:'🌟', name_en:'Star Badge',    name_ar:'شارة النجمة',   cost:100, type:'badge',         rarity:'epic',      durationDays:7, desc_en:'Shining star badge',         desc_ar:'شارة نجمة مضيئة' },
    { id:'badge_vip',     emoji:'⭐', name_en:'VIP Badge',     name_ar:'شارة VIP',      cost:150, type:'badge',         rarity:'epic',      durationDays:7, desc_en:'Exclusive VIP badge',        desc_ar:'شارة VIP حصرية' },
    { id:'badge_diamond', emoji:'💎', name_en:'Diamond Badge', name_ar:'شارة الألماس',  cost:200, type:'badge',         rarity:'legendary', durationDays:7, desc_en:'Legendary diamond badge',    desc_ar:'شارة ألماس أسطورية' },
    { id:'badge_pro',     emoji:'🏆', name_en:'Pro Badge',     name_ar:'شارة المحترف',  cost:250, type:'badge',         rarity:'legendary', durationDays:7, desc_en:'Champion badge',             desc_ar:'شارة البطولة' },
    { id:'badge_legend',  emoji:'👑', name_en:'Legend Badge',  name_ar:'شارة الأسطورة', cost:400, type:'badge',         rarity:'legendary', durationDays:7, desc_en:'Legendary clan badge',       desc_ar:'شارة الأسطورة الحصرية' },
    // -- Titles
    { id:'title_rookie',  emoji:'🌱', name_en:'Rookie',        name_ar:'مبتدئ',         cost:25,  type:'title',         rarity:'uncommon',  durationDays:7, desc_en:'Family rookie title',        desc_ar:'لقب المبتدئ في العائلة' },
    { id:'title_hunter',  emoji:'🎯', name_en:'Hunter',        name_ar:'صياد',          cost:80,  type:'title',         rarity:'rare',      durationDays:7, desc_en:'Clan hunter title',          desc_ar:'لقب الصياد للعائلة' },
    { id:'title_spy',     emoji:'🕵️', name_en:'Mr. Spy',      name_ar:'سيد جاسوس',    cost:150, type:'title',         rarity:'epic',      durationDays:7, desc_en:'Spy clan title',             desc_ar:'لقب الجاسوس للعائلة' },
    { id:'title_pro',     emoji:'⭐', name_en:'Pro Player',    name_ar:'محترف',          cost:200, type:'title',         rarity:'legendary', durationDays:7, desc_en:'Pro player clan title',      desc_ar:'لقب المحترف للعائلة' },
    { id:'title_legend',  emoji:'👑', name_en:'Legend',        name_ar:'أسطورة',         cost:350, type:'title',         rarity:'legendary', durationDays:7, desc_en:'Legendary clan title',       desc_ar:'لقب الأسطورة الحصري' },
    // -- Frames
    { id:'frame_mint',    emoji:'🪟', name_en:'Mint Frame',    name_ar:'إطار نعناعي',   cost:50,  type:'frame',         rarity:'uncommon',  durationDays:7, desc_en:'Refreshing mint frame',      desc_ar:'إطار نعناعي منعش' },
    { id:'frame_ice',     emoji:'🧊', name_en:'Ice Frame',     name_ar:'إطار الجليد',   cost:120, type:'frame',         rarity:'rare',      durationDays:7, desc_en:'Cool ice frame',             desc_ar:'إطار الجليد البارد' },
    { id:'frame_fire',    emoji:'🔥', name_en:'Fire Frame',    name_ar:'إطار نار',      cost:200, type:'frame',         rarity:'epic',      durationDays:7, desc_en:'Blazing fire frame',         desc_ar:'إطار النار المشتعل' },
    { id:'frame_gold',    emoji:'🥇', name_en:'Gold Frame',    name_ar:'إطار ذهبي',     cost:300, type:'frame',         rarity:'legendary', durationDays:7, desc_en:'Shining gold frame',         desc_ar:'إطار ذهبي لامع' },
...
// Using typeof guards so a missing variable doesn't crash the entire script
if (typeof CHEST_CONFIG !== 'undefined') window.CHEST_CONFIG = CHEST_CONFIG;
...
if (typeof ACTIVENESS_MILESTONES !== 'undefined') window.ACTIVENESS_MILESTONES = ACTIVENESS_MILESTONES;
